...
function galene_styles(){
		...
		wp_enqueue_style( 'galene_stylesheet', get_stylesheet_uri() );


		
		

		wp_register_style( 'quicksand','link href="https://fonts.googleapis.com/css?family=Quicksand:300,400,500,700", array() ' );
		wp_enqueue_style('quicksand');

		wp_register_style( 'opensans','link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800", array(), true ' );
		wp_enqueue_style('opensans');

		wp_register_style( 'fontawesome','link href="https://use.fontawesome.com/4c62e67981.js", array() , true' );
...
add_action( 'wp_enqueue_scripts', 'galene_styles' );


register_nav_menus( array(

	'main_menu'=> __('Main Menu', 'galeneluxury'),#This Way We Added Menus to our wordpress Theme!
	'top_menu'=> __('Top Menu', 'galeneluxury')
...
add_image_size( 'half', 600, 550, true );
